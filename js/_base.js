...
hasClass = function(e, cls) {
    if (e instanceof SVGElement) {
        return e.className.baseVal.match(getClass(cls)) === null ? false : true;
    } else {
        return e.className.match(getClass(cls)) === null ? false : true;
    }
},
    ...
    if (hasClass(e, cls)) {
        if (e instanceof SVGElement) {
            ...
            if (e.className.baseVal.match('(?:\\w|\\d)(?:\\s+|^)(' + cls + '\\b)(?:\\s+|$)(?:\\w|\\d)') === null) {
                e.className.baseVal = e.className.baseVal.replace(getClass(cls), '');
            } else {
                e.className.baseVal = e.className.baseVal.replace(getClass(cls), ' ');
            }
        } else {
            ...
            if (e.className.match('(?:\\w|\\d)(?:\\s+|^)(' + cls + '\\b)(?:\\s+|$)(?:\\w|\\d)') === null) {
                e.className = e.className.replace(getClass(cls), '');
            } else {
                e.className = e.className.replace(getClass(cls), ' ');
            }
        }
...
getFraction = function(num, plc) {
    var place = (!plc) ? 2 : plc,
        s = num.toFixed(place).toString();
  return parseFloat(s.slice((s.indexOf('.'))));
},
